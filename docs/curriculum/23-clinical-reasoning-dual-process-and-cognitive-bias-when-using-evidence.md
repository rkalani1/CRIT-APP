...
Critical appraisal is not merely an analytical exercise on paper; it is a cognitive discipline executed by clinicians subject to heuristic biases. Clinical decisions under time pressure rely on dual-process cognition: rapid, pattern-matching System 1 intuition and slow, analytical System 2 deliberation.

In high-velocity cerebrovascular practice, cognitive biases—such as availability bias, confirmation bias, and framing effects—can distort how clinicians interpret trial results. Mastered appraisal acts as a cognitive debiasing mechanism, forcing System 2 scrutiny before adopting new practice patterns.
