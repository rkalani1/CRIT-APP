...
4. Locate a stroke trial that was stopped early for efficacy by a DSMB. Explain mathematically why the reported treatment effect size is highly likely to be an overestimate of the true population parameter.
...
8. Explain the ITT paradox in non-inferiority trials. Detail why poor adherence makes the experimental and control arms appear statistically equivalent, driving an anti-conservative false conclusion.
